...
class MainWindow(QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.browser.setUrl(QUrl.fromLocalFile(wdir+'/folium.html'))
        ...
        reload_btn = QAction("Update", self)
        reload_btn.setStatusTip("Update Map")

        # adding action to the reload button
        # making browser to reload
        reload_btn.triggered.connect(self.updateMap)
